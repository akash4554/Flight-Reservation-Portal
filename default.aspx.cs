...
namespace SkyShark1
{
	...
	public class WebLogonForm : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Button txtSubmit;
		...
		protected SkyShark1.userDataSet1 userDataSet11;
		...
		{    
			...
			this.userDataSet11 = new SkyShark1.userDataSet1();
			((System.ComponentModel.ISupportInitialize)(this.userDataSet11)).BeginInit();
			...
			this.userDataSet11.Locale = new System.Globalization.CultureInfo("en-US");
			this.Load += new System.EventHandler(this.Page_Load);
			((System.ComponentModel.ISupportInitialize)(this.userDataSet11)).EndInit();
		...
		private void txtSubmit_Click(object sender, System.EventArgs e)
		{
			...
			datarows=sqlDataAdapter1.Fill(userDataSet11,"UserDetails");
